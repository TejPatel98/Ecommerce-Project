...
<body class='container'>
  ...
  <div style="margin: 5px; padding: 5px;">
    ...
    <form action='' class="form-group" method='post'>
      ...
      Keyword: <input type="text" class="form-control" name="keywords" size="15">
    ...
    if (isset($_POST['submitProduct'])) {
      ...
      $productAddition = "insert into Product values (" . intval($_POST["id"]) . ", '" . $_POST["name"] . "', '" . $_POST["keywords"] . "', NULL, " . $_POST["cost"] . ", 5, '" . $_POST["image"] . "');";
